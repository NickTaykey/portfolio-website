      ...
      <Accordion mb="6" allowMultiple>
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            ...
            developing and deploying static websites. Moreover, it makes the
            whole content management process very easy (you just write plain
            HTML). Among the many UI frameworks, I went for ChakraUI because, in
            my opinion, it offers the best compromise between{' '}
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            ...
            (founder of Inkdrop). I customized a lot the template of his
            project, simplifying it and making it fir my needs. And whoala, here
            I have an awesome portfolio.{' '}
